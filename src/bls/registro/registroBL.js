  ...
  const ordenaDatos = (registro, estudiante, usuarioCreacion, usuarioActual) => {
    ...
    if (registro[0].tipo === 'especialidad') {
      switch (registro[0].area) {
        ...
        datosOrdenados.registro.motor_kick = registro[0].reg_pm.motor_kick;
        datosOrdenados.registro.motor_staticDinamicBalance = registro[0].reg_pm.motor_staticDinamicBalance;
        datosOrdenados.registro.motor_staticBalance = registro[0].reg_pm.motor_staticBalance;
        datosOrdenados.registro.motor_partialDisociation = registro[0].reg_pm.motor_partialDisociation;
        datosOrdenados.registro.motor_generalCoordination = registro[0].reg_pm.motor_generalCoordination;
        ...
        datosOrdenados.registro.motor_scrash = registro[0].reg_pm.motor_scrash;
        datosOrdenados.registro.motor_button = registro[0].reg_pm.motor_button;
        datosOrdenados.registro.motor_cut = registro[0].reg_pm.motor_cut;
        datosOrdenados.registro.motor_makeTower = registro[0].reg_pm.motor_makeTower;
        datosOrdenados.registro.motor_threadingNeedle = registro[0].reg_pm.motor_threadingNeedle;
        datosOrdenados.registro.motor_observaciones = registro[0].reg_pm.motor_observaciones;
        datosOrdenados.registro.cogni_drawsHumanFigure = registro[0].reg_pm.cogni_drawsHumanFigure;
        datosOrdenados.registro.cogni_nameHumanParts = registro[0].reg_pm.cogni_nameHumanParts;
        datosOrdenados.registro.cogni_compleateHumanFigure = registro[0].reg_pm.cogni_compleateHumanFigure;
        datosOrdenados.registro.cogni_bodyImage = registro[0].reg_pm.cogni_bodyImage;
        ...
        datosOrdenados.registro.cogni_undifferentiatedCrying = registro[0].reg_pm.cogni_undifferentiatedCrying;
        datosOrdenados.registro.cogni_socialSmile = registro[0].reg_pm.cogni_socialSmile;
        datosOrdenados.registro.cogni_vocalGame = registro[0].reg_pm.cogni_vocalGame;
        datosOrdenados.registro.cogni_babbleReflection = registro[0].reg_pm.cogni_babbleReflection;
        datosOrdenados.registro.cogni_gutturalSound = registro[0].reg_pm.cogni_gutturalSound;
        datosOrdenados.registro.cogni_gestures = registro[0].reg_pm.cogni_gestures;
        datosOrdenados.registro.cogni_intentionalSyllable = registro[0].reg_pm.cogni_intentionalSyllable;
        datosOrdenados.registro.cogni_juxtaposedWord = registro[0].reg_pm.cogni_juxtaposedWord;
        datosOrdenados.registro.cogni_simplePhrase = registro[0].reg_pm.cogni_simplePhrase;
        datosOrdenados.registro.cogni_phraseWord = registro[0].reg_pm.cogni_phraseWord;
        datosOrdenados.registro.cogni_languageInteriorization = registro[0].reg_pm.cogni_languageInteriorization;
        datosOrdenados.registro.cogni_waitTurn = registro[0].reg_pm.cogni_waitTurn;
        datosOrdenados.registro.cogni_completePhrase = registro[0].reg_pm.cogni_completePhrase;
        datosOrdenados.registro.cogni_gramaticalElemmentUse = registro[0].reg_pm.cogni_gramaticalElemmentUse;
        datosOrdenados.registro.cogni_makeComplexeSentences = registro[0].reg_pm.cogni_makeComplexeSentences;
        datosOrdenados.registro.cogni_fullfillComplexOrder = registro[0].reg_pm.cogni_fullfillComplexOrder;
        datosOrdenados.registro.cogni_beginReadingWriting = registro[0].reg_pm.cogni_beginReadingWriting;
        datosOrdenados.registro.cogni_usePreposition = registro[0].reg_pm.cogni_usePreposition;
        datosOrdenados.registro.cogni_useAdjectives = registro[0].reg_pm.cogni_useAdjectives;
        datosOrdenados.registro.cogni_slangLanguage = registro[0].reg_pm.cogni_slangLanguage;
        datosOrdenados.registro.cogni_useAdjectivesAdverbs = registro[0].reg_pm.cogni_useAdjectivesAdverbs;
        datosOrdenados.registro.cogni_verbUse = registro[0].reg_pm.cogni_verbUse;
        datosOrdenados.registro.cogni_fluidCommunication = registro[0].reg_pm.cogni_fluidCommunication;
        datosOrdenados.registro.cogni_observaciones = registro[0].reg_pm.cogni_observaciones;
        datosOrdenados.registro.socio_plays = registro[0].reg_pm.socio_plays;
        datosOrdenados.registro.socio_proposeGame = registro[0].reg_pm.socio_proposeGame;
        datosOrdenados.registro.socio_leaderInGames = registro[0].reg_pm.socio_leaderInGames;
        datosOrdenados.registro.socio_acceptAnothersGame = registro[0].reg_pm.socio_acceptAnothersGame;
        datosOrdenados.registro.socio_otherGame = registro[0].reg_pm.socio_otherGame;
        datosOrdenados.registro.socio_acceptIt = registro[0].reg_pm.socio_acceptIt;
        datosOrdenados.registro.socio_searchIt = registro[0].reg_pm.socio_searchIt;
        datosOrdenados.registro.socio_provokesIt = registro[0].reg_pm.socio_provokesIt;
        datosOrdenados.registro.socio_thanksHim = registro[0].reg_pm.socio_thanksHim;
        datosOrdenados.registro.socio_waitGrownUpApprovation = registro[0].reg_pm.socio_waitGrownUpApprovation;
        datosOrdenados.registro.socio_waitOrders = registro[0].reg_pm.socio_waitOrders;
        datosOrdenados.registro.socio_collaborateWithAdult = registro[0].reg_pm.socio_collaborateWithAdult;
        datosOrdenados.registro.socio_otherAdult = registro[0].reg_pm.socio_otherAdult;
